    ...
    return (
        <div className='about_us'>  
            ...
            <div className='DOLZHENKO' >
                <Text width={"50%"} marginLeft={"50px"} backgroundColor={"#EBECFC"} fontSize={'2em'}> Лаборатория социально-экономических исследований в Арктике - это научно-исследовательский центр Заполярного государственного университета, специализирующийся на изучении социально-экономического развития арктического региона. Она является одним из ключевых элементов системы научных исследований в России и вносит значительный вклад в разработку стратегий и программ развития Арктики.
